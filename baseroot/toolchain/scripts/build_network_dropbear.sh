...
SRC_DIR="$BASE_DIR/src/dropbear-2026.93"
...
if [ ! -d "$SRC_DIR" ]; then
    wget https://dropbear.nl/mirror/releases/dropbear-2026.93.tar.bz2
    cp -f dropbear-2026.93.tar.bz2 "$BASE_DIR/src" 
    cd "$BASE_DIR/src"
    tar xfj dropbear-2026.93.tar.bz2
    cd -
fi
